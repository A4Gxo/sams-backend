...
class AnyUrl(_BaseUrl):
    ...
    * Host not required
    ...
    Assuming an input URL of `http://samuel:pass@example.com/the/path/?query=here#fragment=is;this=bit`,
...
if TYPE_CHECKING:
    ...
    class IPvAnyAddress:
        ...
        print(IpModel(ip='sams-zsar.onrender.com'))
        #> ip=IPv4Address('sams-zsar.onrender.com')
